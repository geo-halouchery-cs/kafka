...
public final class WordTagger {
    ...
    static Properties getStreamsConfig(final String[] args) throws IOException {
        ...
        props.putIfAbsent(StreamsConfig.APPLICATION_ID_CONFIG, "streams-wordtagger");
    ...
    public static String getLemma(String word) {
        return lexique.getOrDefault(word, word);
    }
    ...
    static void createWordFilterStream(final StreamsBuilder builder) {
        ...
        lemmatizedWords.to(OUTPUT_TOPIC, Produced.with(Serdes.String(), Serdes.String()));
